...
async function getStaticProps() {
  // fetch data from an API
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://raduloov:aaaaaaaa@cluster0.yejom.mongodb.net/myFirstDatabase?retryWrites=true&w=majority');
  const db = client.db();
